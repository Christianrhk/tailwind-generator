...
<head>
    <meta charset="utf-8">
    <title>Digilib Universitas Prof. Dr. Hazairin, SH</title>
    ...
    <meta property="og:title" content=" | "/>
      ...
      <meta property="og:url" content="//digilib.unihaz.ac.id%2Findex.php"/>
    <meta property="og:site_name" content=""/>
        <meta property="og:image"
            content="//digilib.unihaz.ac.id/template/default/img/logo.png"/>
  
    <meta name="twitter:card" content="summary">
    <meta name="twitter:url" content="//digilib.unihaz.ac.id%2Findex.php"/>
    ...
    <link href="/js/toastr/toastr.min.css?31032742" rel="stylesheet" type="text/css"/>
    <!-- SLiMS CSS -->
    <link rel="stylesheet" href="/js/colorbox/colorbox.css">
    <!-- // Flag css -->
    <link rel="stylesheet" href="template/default/assets/css/flag-icon.min.css">
    <!-- // my custom style -->
    <link rel="stylesheet" href="template/default/assets/css/style.css?v=20220809-032742">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
    <a class="navbar-brand inline-flex items-center" href="index.php">
        <img class="h-16 w-15" src="images/default/logo.png">        <div class="inline-flex flex-col leading-tight ml-2">
            <h1 class="text-lg m-0 p-0"></h1>
                    </div>
    </a>
    ...
    <a class="nav-link" href="index.php?p=ketentuan_anggota">Informasi</a>
</li><li class="nav-item ">
...
<footer class="py-4 bg-grey-darkest text-grey-lighter">
    <div class="container">
        <div class="row py-4">
            <div class="col-md-3">
              <img class="h-12 mb-2" src="images/default/logo.png">                <div class="mb-4"></div>
                <ul class="list-reset">
                    <li><a class="text-light" href="index.php?p=ketentuan_anggota">Informasi</a></li>
            ...
            <div class="col-md-5 pt-8 md:pt-0">
                ...
                <p>
                    UPT Perpustakaan<br />Universitas Prof. Dr. Hazairin, SH<br />Jl. Jendral Ahmad Yani No. 1 Kota Bengkulu<br />Bengkulu - Indoensia                </p>
            </div>
        ...
        <div class="flex font-thin text-sm">
            <p class="flex-1">&copy; 2022 &mdash; Universitas Prof. Dr. Hazairin, SH</p>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="colltype" class="form-control"
                                    id="adv-coll-type"><option value="0">Semua Koleksi</option><option value="Fiction">Fiction</option><option value="Koleksi Referensi">Koleksi Referensi</option><option value="Textbook">Textbook</option></select>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select id="adv-location" name="location"
                                    class="form-control"> <option value="0">Semua Lokasi</option><option value="Perpustakaan Universitas Prof. Dr. Hazairin, SH">Perpustakaan Universitas Prof. Dr. Hazairin, SH</option></select>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<!-- // load our vue app.js -->
<script src="template/default/assets/js/app.js?v=20220809-032742"></script>
<script src="template/default/assets/js/app_jquery.js?v=20220809-032742"></script>
