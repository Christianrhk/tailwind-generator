...
<title>Contact Ashley Bryan Bernina Sewing Reviews</title>
<style>
.sticky {
  position: fixed;
  top: 0;
...
if(e)
{
    ...
    &nbsp;
           ...
           Swiss precision.        </h2> <p class="text-base text-gray-700 md:text-lg">
          As a family business, BERNINA wants to ensure that your creations can be implemented with the best technology.        </p></div> <div><a href="go-now.php" class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-500 hover:bg-indigo-500 focus:shadow-outline focus:outline-none">
          Visit Our Website to Learn More!        </a></div></div></div></div> <div class="bg-white p-8">
<div class="max-w-md mx-auto bg-blue-200 rounded-xl shadow-md overflow-hidden md:max-w-5xl p-8">
    <div class="form-container p-8">
        <form name="frmContact" id="" frmContact"" method="post"
            ...
            <div class="py-8">
                <input type="submit" name="send" class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-500 hover:bg-indigo-500 focus:shadow-outline focus:outline-none"
                    value="Send" />
...
</html><div class="px-4 py-16 mx-auto w-full md:px-24 lg:px-8 lg:py-16 bg-gray-200"><div class="max-w-xl sm:mx-auto lg:max-w-2xl"><div class="flex flex-col mb-16 sm:text-center sm:mb-0"><div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12"><h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
           Swiss precision.        </h2> <p class="text-base text-gray-700 md:text-lg">
          As a family business, BERNINA wants to ensure that your creations can be implemented with the best technology.        </p></div> <div><a href="go-now.php" class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-indigo-500 hover:bg-indigo-500 focus:shadow-outline focus:outline-none">
          Visit Our Website to Learn More!        </a></div></div></div></div> <div class="bg-gray-200 px-4 pt-16 mx-auto w-full border-opacity-10 md:px-24 lg:px-8"><div class="max-w-6xl mx-auto grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4"><div class="sm:col-span-2"><a href="/" aria-label="Go home" title="Company" class="inline-flex items-center"><svg viewBox="0 0 24 24" stroke-linejoin="round" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" stroke="currentColor" fill="none`" class="w-8 text-indigo-500"><rect x="3" y="1" width="7" height="12"></rect> <rect x="3" y="17" width="7" height="6"></rect> <rect x="14" y="1" width="7" height="6"></rect> <rect x="14" y="11" width="7" height="12"></rect></svg> <span class="ml-2 text-xl font-bold tracking-wide text-gray-900 uppercase">Ashley Bryan Bernina Sewing Reviews</span></a> </div>
