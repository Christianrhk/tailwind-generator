...
<head>
	...
	<title>Utah Genealogical Association - Members</title>
...
<div id="navColumn">
				...
				<div class="navParentH" onClick="location.href='members.php';" style="cursor:pointer;">
										<a href="members.php" class="navLinkH">Members</a>
								</div>
					   
				<div class="navChild1" onClick="location.href='eventListings.php?nm=673';" style="cursor:pointer;">
										<a href="eventListings.php?nm=673" class="navSubLink">Events</a>
								</div>
					   
				<div class="navChild" onClick="location.href='store.php?sid=3';" style="cursor:pointer;">
										<a href="store.php?sid=3" class="navSubLink">Membership Specials</a>
								</div>
	...
	<td id="colRight" valign="top">
		...
		<tr>
					<td id="contentHeader"></td>
		</tr><tr>
					<td id="contentArea"><div id="contentArea">
	<div align="center">
		<div style="margin-top:40px;width:65%;text-align:left;">
					</div>
	</div>
	<br class="clearfloat">

	<form name="loginForm" id="loginForm" method="post" action="/members.php">
			<div style="text-align:center; margin-top:40px;">
			<label class="formLabel" style="width:80px; display:inline-block; height:100%; vertical-align:middle;" for="ENSLogin">Login Name:</label>
			<input class="formInput" style="width:200px; display:inline-block; height:100%; vertical-align:middle;" type="text" name="ENSLogin" id="ENSLogin" value="" maxlength="60" tabindex="1">
			<img  style="cursor:pointer; display:inline-block; height:100%; vertical-align:middle;" src="images/ens/ens_qstmark.jpg" width="18" height="18" border="0" alt="Forgotten login name?" title="Forgotten login name?" onclick="pwin=window.open('util/userMaint.php?mod=lir','pwin','width=600,height=300,top=24,left=24'); pwin.focus(); return false;" />
		</div>

		<div style="text-align:center; margin-top:10px;">
			<label class="formLabel" style="width:80px; display:inline-block; height:100%; vertical-align:middle;" for="ENSLogin">Password:</label>
			<input class="formInput" style="width:200px; display:inline-block; height:100%; vertical-align:middle;" type="password" name="ENSPswd" id="ENSPswd" value="" maxlength="40" tabindex="2">
			<img  style="cursor:pointer; display:inline-block; height:100%; vertical-align:middle;" src="images/ens/ens_qstmark.jpg" width="18" height="18" border="0" alt="Lost or forgotten password?" title="Lost or forgotten password?" onclick="pwin=window.open('util/userMaint.php?mod=pwr','pwin','width=600,height=300,top=24,left=24'); pwin.focus(); return false;" />
		</div>

		<div style="text-align:center; margin-top:10px;">
			<input type="submit" name="submit" id="submit" value="Login" class="btnStd" onmouseover="this.className='btnStdH'" onmouseout="this.className='btnStd'" onfocus="this.className='btnStdH'" onblur="this.className='btnStd'" tabindex="3">
		</div>
		</form>	

<!-- Display Bottom Content Box -->
	<div align="center">
		<div style="margin-top:40px; width:65%; text-align:left;">
			<div><span style="font-size: 14px;"><strong>Login Problems?</strong></span></div>

<div>&nbsp;</div>

<div>Click on the ? icon to the right of the Login Name or Password field if you do not remember your user name and password.&nbsp; The user name and password re-set instructions will be sent to your email.</div>
		</div>
	</div>
	...
	<!--
		document.getElementById('ENSLogin').focus();
	//-->
	</script>
</div></td>
				</tr>
