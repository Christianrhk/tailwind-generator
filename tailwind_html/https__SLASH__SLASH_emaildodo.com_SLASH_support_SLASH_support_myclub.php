        ...
        <div class="">
            ...
            <div class="mt-10">
                ...
                <div>   
                    ...
                    <br/>     
                	<img class="border border-gray-700" src="../images/myclubemail.png">
                ...
                <hr class="hrline2">               
           		<div>
                    ...
                    <br/>
               		 <img class="border border-gray-700" src="../images/myclubquestion.png"></br>
                	...
                	<img class="border border-gray-700" src="../images/myclubanswers.png"></br>
                ...
                <div class="text-blue-big-bold">
                	EMAILS OF THE CLUB<a href="#top">&nbsp;<img src="../images/arrownew.png" width=30 align=right></a>
    			</div>
                <hr class="hrline2">
            	<div>
                	<p class="">General emails of the club, like Newsletters, can also be send via the eMailDodo emailgrouping system.<br/>
                    <br/> 
                    With the Admin Only feature you can send eMails, but members can not sent eMails back.</p>
            	</div>
