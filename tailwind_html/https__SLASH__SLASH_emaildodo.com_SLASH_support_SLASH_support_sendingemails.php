...
<div class="bg-gray-200 mt-20 flex justify-center relative ">
    <div class="mx-10 sm:mx-20 md:mx-32 lg:mx-56 text-blue-normal">
        ...
        <span class="text-green-big">
        	Have you Signed Up?<br/>
        	Created a Group?<br/>
        	Start sending eMails!<br/>
        </span>
        <br/>
        <br/>
        <div class="">
            <div class="text-blue-big-bold">SENDING EMAILS
                <a href="#top">
                    <img src="/images/arrownew.png" width=30 align=right></a>
            </div>
            <hr class="hrline2">
            You, the members in the group, or everybody
            <i>(optional)</i>,
            can send emails to the group.
            From anywhere on any laptop, pc or mobile device.
            <br/><br/>
            Just use your eMailDodo group email address:<br/>
            <br/><br/>
            <center>
            	<img style="border: solid 20px #E2E8F0;" src="/images/group.png" width="440" height="85"><br/>
           		<span class="text-gray-small">(example for a group called "classof85")</span>
           	</center>
            <br/>
            <br/>
            Your email message will be sent to all email addresses in the group.
            <br/>
            <br/>
            <br/>
        </div>
        <br/>
        <div class="">
            <div class="text-blue-big-bold">SENDING EMAILS FROM THE WEBSITE
                <a href="#top">
                    <img src="/images/arrownew.png" width=30 align=right>
                </a>
            </div>
            <hr class="hrline2">
            If you are signed in you can also send emails from the website. <br/>
            Click on
                <img class="inline" src="/images/sendmail.gif" width="100" height="27" border="0">
            <br/>
            <br/>
            <br/>
        </div>
        <br/>
        <div class="">
            <div class="text-blue-big-bold">EXTRA FEATURES
                <a href="#top">
                    <img src="/images/arrownew.png" width=30 align=right>
                </a>
            </div>
            <hr class="hrline2">
                Check out the extra features:<br/>
            <br/>
            <ul>
                <li>
                	• Let all members know they are in a new group.
                    <img class="inline" src="/images/sendnewgroup.gif" align="bottom" width="150" height="27">
                </li>
                <li>
                	• Send your group an update of who is in the email group.
                    <img class="inline" src="/images/sendcurrentmem.gif" align="bottom" width="150" height="27">
                </li>
            </ul>
            <br/>
            <br/>
