                                    ...
                                    <nav>
											...
											<li><a href="finca.php">UNSERE FINCA</a></li>											
												<!--<ul class="submenu-mainmenu">
												    ...
												    <li><a href="ficha.php?Id=4">Dose 5l</a></li>
                ...
                <div class="row" style="margin-top: 60px;margin-bottom: 70px;">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="about-info">
                                <h2>FINCA CAN OLIVERAS</h2>
                                <p>Unsere Finca Can Oliveras befindet sich auf der Insel Mallorca, gerade mal 2 Minuten vom Stadtzentrum Campos entfernt zwischen Campos und Santanyi. Campos ist eine Stadt mit ländlichem Charakter im Landesinneren von Mallorca, ca. 9 km Luftlinie von dem berühmten Natur-Strand Es Trenc entfernt. <br><br>
Auf unserer Finca wachsen über 625 Olivenbäume der Sorte Arbequina. Die Finca Can Oliveras besitzt darüber hinaus zahlreiche Orangen, Mandarinen, Zitronen- und Feigenbäume, sowie mehrere Gemüseplantagen. Auf ca. 60 Hektar wachsen sämtliche Pflanzen aus dem mediterranen Umfeld und sorgen mit vielen Kräutern und Blumen für einen einzigartigen Duft. <br><br>
Neben vielen Haustieren wie Hunden und Katzen beherbergen wir ca. 100 Hühner die uns reichlich Bio Eier für den Eigenbedarf liefern. <br><br>
Darüber hinaus werden wir mit den schönsten Sonnenuntergängen und einem einzigartigen Panoramablick verwöhnt. 
</p>
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="about-img">
                                <a href="galeria.php"><img src="img/about/1.jpg" alt=""></a>
                            </div>
                        </div>
						 <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="about-img">
								<a href="galeria.php" class="slider-button">Bilder von der Finca</a>                                
							</div>
                        </div>
   ...
   <!-- popular start-->
            ...
            <div class="container">
                ...
                <div class="row">
                            ...
                            <div class="single-product">
                                ...
                                <div class="single-product-hover">
                                    <div class="single-product-hover-text">
                                        ...
                                        <h4  style="font-size: 22px;"><a href="ficha.php?Id=1">6.95€</a></h4>
                            ...
                            <div class="single-product">
                                ...
                                <div class="single-product-hover">
                                    <div class="single-product-hover-text">
                                        ...
                                        <h4  style="font-size: 22px;"><a href="ficha.php?Id=2">8.95€</a></h4>
                                        <ul class="cart-metalic">
                            ...
                            <div class="single-product">
                                ...
                                <div class="single-product-hover">
                                    <div class="single-product-hover-text">
                                        ...
                                        <h4  style="font-size: 22px;"><a href="ficha.php?Id=3">9.95€</a></h4>
                                        <ul class="cart-metalic">
                            ...
                            <div class="single-product">
                                ...
                                <div class="single-product-hover">
                                    <div class="single-product-hover-text">
                                        <h2 style="font-size: 24px;font-weight: 500;">Dose 5l</h2>
                                        <h4  style="font-size: 22px;"><a href="ficha.php?Id=4">49.00€</a></h4>
                                        <ul class="cart-metalic">
        ...
        <script src="js/main.js"></script>
			 ...
			 Diese Website verwendet eigene Cookies, um Informationen zu sammeln, um unsere Dienste zu verbessern und Ihre Surfgewohnheiten zu analysieren.<br> Der Benutzer hat die Möglichkeit, HIER seine Präferenzen zu konfigurieren. <a href="#" onclick="MM_openBrWindow('setCookie.php?Confcookie=Si','cookies','scrollbars=yes,width=640,height=480'); return false;">Hier</a>.<br><br>
			  ...
			  <button id="catapultCookie" onclick="cargarZonaAJAX('/setCookie.php?set=2022-08-08&Allcookie=Si', 'catapult-cookie-barDiv', 'images/ajax-loader.gif');">AKZEPTIERE ALLE</button>
			   <button id="catapultCookie" onclick="cargarZonaAJAX('/setCookie.php?set=2022-08-08&Allcookie=No', 'catapult-cookie-barDiv', 'images/ajax-loader.gif');">ALLES ABLEHNEN</button><br><br>
