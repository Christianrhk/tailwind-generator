...
<div class="bg-gray-200 pt-12 w-screen justify-center">
    <div class="mx-10 sm:mx-20 md:mx-32 lg:mx-56 text-blue-normal">
        <div class="mt-20 mb-10">
            <div class="text-blue-xlarge-bold flexcol mb-10">
                HelpDesk.
            </div>
            <span class="text-blue-big-bold mb-20">
                Tell us what is on your mind and we'll try to help you.
            </span>
        </div>
        <div class="flex flex-col md:flex-row justify-center">
            <img class="flex-1 w-64 md:w-full mr-10 mb-5" alt="edodoteam" src="/images/the-edodo-team.png"/>
            <div class="flex flex-col md:flex-row flex-1 text-blue-normal">
                <div class="flex-1 text-justify mr-5">
                    <span class="text-green-big-bold">Natesh on<br/> Richard:</span><br/><br/>
                    He's English or something, but he claims to know how to write code so it's ok. I've seen him program
                    a VCR once so he must know technology.
                </div>
                <div class="flex-1 text-justify">
                    <span class="text-green-big-bold">Richard on<br/> Natesh:</span><br/><br/>
                    I'm not really sure what he does, but it's fun having him around.
                    Once in a while he answers a quiry and chats to people about some internet thing, but i'm pretty
                    sure no one's on the other end of the chat.
                </div>
            </div>
        </div>
        <div class="justify-center">
            <div class="my-10 sm:my-1">
                ...
                We hate contact forms too, but it helps weed out the spam.</br>
                So please fill out the required fields in the form below.</br>
                </br>
                <span class="text-blue-large-bold">Contact us</span>
            </div>
            <form action="/files/mailer.php" method="post" enctype="multipart/form-data">
                <div class="w-full">
                    <div class="bg-gray-100 border border-solid border-gray">
                        <div class="flex flex-col justify-center p-2 md:p-10">
                            <div class="flex flex-col md:flex-row">
                                <div class="md:flex-1 px-2 text-blue-normal flex flex-col">
                                    <label>Your Name :</label>
                                    <input name="form[element0]" class="border border-solid border-gray-300 px-2 text-black" type="text">
                                </div>
                                <div class="md:flex-1 px-2 text-blue-normal flex flex-col">
                                    <label class="">Your Email :</label>
                                    <input name="form[element1]" class="border border-solid border-gray-300 px-2 text-black" type="text">
                                </div>
                            </div>
                            <br/>
                            <div class="flex flex-col md:flex-row">
                                <div class="md:flex-1 px-2 text-blue-normal flex flex-col">
                                    ...
                                    <input name="form[element2]" class="border border-solid border-gray-300 px-2 text-black" type="text">
                                </div>
                                <div class="md:flex-1 px-2 text-blue-normal flex flex-col">
                                    <label class="">Subject :</label>
                                    <input name="form[element3]" class="border border-solid border-gray-300 px-2 text-black" type="text">
                                </div>
                            </div>
                            <br/>
                            <div class="w-full px-2 text-blue-normal">
                                <label>On my mind :</label>
                                <select name="form[element4]" class="text-sm block appearance-none w-full bg-white border border-gray-300 text-gray-700 py-3 px-4 pr-8 leading-tight focus:outline-none">
                            ...
                            <br/>
                            <div class="px-2 text-blue-normal flex flex-col">
                                <label>Message :</label>
                                <textarea name="form[element5]" class="border border-solid border-gray-300 text-black px-2 pt-2" style="height: 200px;"></textarea>
                                <div class="flex justify-start text-sm md:text-lg font-bold mt-5">
                                    <div class="divbtn green-background mr-5"><a class="abtn py-1" href="#" onclick="this.closest('form').reset();return false;">Reset</a></div>
                                    <div class="divbtn green-background ml-5"><a class="abtn py-1" href="#" onclick="this.closest('form').submit();return false;">Send eMail</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <input type="hidden" name="form_token" value="179810910662f000dcd5b76"/>
					<br/><br/><br/><br/><br/>
                </div>
            </form>
        </div>
