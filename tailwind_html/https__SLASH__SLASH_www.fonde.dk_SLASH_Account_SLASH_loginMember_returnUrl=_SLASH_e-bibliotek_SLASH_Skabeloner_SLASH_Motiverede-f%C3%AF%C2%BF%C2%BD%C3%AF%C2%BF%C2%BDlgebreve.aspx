...
<ul class="top-nav w-full lg:w-auto toggle-mobile-menu">
    <li class="w-full md:w-auto nav-item relative pointer ">
        ...
        <div id="loginFormNew" class="absolute  header-Login-dropdown">
            <input name="__RequestVerificationToken" type="hidden" value="b771M0JCnxg7TzL3pccY9RCPh1j_L6OETmjfZA7wj0sg0DqYLCLMTaQKkW6G7SOunuFeH8Fqw-SVsgKjJ9pcD0VDu5G93DIfg5XQJW6go681" />
            <fieldset>
                        ...
                        <form action="/Account/ForgotPassword" method="post">
                            <div class="ro">
                                ...
                                <div class="form-group pt-5 ForgotPassword-step-1" style="    margin-bottom: 45px;">
                                    <input name="__RequestVerificationToken" type="hidden" value="ASC9x866w_tptkA651xANeJ_CmNKWNqxPmFzYUsYm4W5Y_kYdC5ks1v1NuCKCkEsxzJpX9psED6ipGkNGfdWjTtzoMMoKxk6rh4POW1ueIY1" />
...
<form action="/Account/Login?ReturnUrl=%2Fe-bibliotek%2FSkabeloner%2FMotiverede-f%C3%AF%C2%BF%C2%BD%C3%AF%C2%BF%C2%BDlgebreve.aspx" method="post" name="loginpage" onsubmit="return validateForm()" style="width: 100%;"><input name="__RequestVerificationToken" type="hidden" value="EaI-D4P9QmElN-aZ5Im4GOgO_PW-nVzDRwzRKB3Z00STZ4HvhquI1ivWvTX_shpTeaITAaIvCohFpM4XT7q6TdkcqgLza90vqVSf_OGwX141" />            <div class="col-xs-12 p-2">
                <h5>
