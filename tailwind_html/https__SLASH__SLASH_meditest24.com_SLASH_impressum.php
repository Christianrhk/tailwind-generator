    ...
    <section class="border-b py-8 bg-white">
      <div class="container mx-auto py-6 mb-12">
        <div class="text-black">
          <h4 class="mb-2 mt-4 text-2xl">Angaben gemäß § 5 TMG:</h5>
          <p class="text-muted"></p>

          <h4 class="mb-2 mt-4 text-2xl"></h5>
          <p class="text-muted">MediTest24.com ist ein Angebot der</p>
          <p class="text-muted">
            <b>mockingbird GmbH</b><br />Königsallee 27<br />40212 Düsseldorf
          </p>
          <p class="text-muted">Geschäftsführer: David Rüther</p>
          <p class="text-muted">
            Handelsregister: Amtsgericht Düsseldorf HRB 84384
          </p>
          <p class="text-muted">
            Umsatzsteuer Identifikationsnummer: DE321566169
          </p>
          <p class="text-muted">
            Telefon: +49 211 – 73 71 07 07<br />
            Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cca5a2aaa38ca1a9a8a5b8a9bfb8fef8e2afa3a1">[email&#160;protected]</a>
          </p>

          <h4 class="mb-2 mt-4 text-2xl">Pressekontakt</h5>
          <p class="text-muted"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ff8f8d9a8c8c9abf929a9b968b9a8c8bcdcbd19c9092">[email&#160;protected]</a></p>

          <h4 class="mb-2 mt-4 text-2xl">Medizinprodukte-Beauftragter:</h5>
          <p class="text-muted"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fb999d968b88bb969e9f928f9e888fc9cfd5989496">[email&#160;protected]</a></p>

          <h4 class="mb-2 mt-4 text-2xl">EU-Streitschlichtung</h5>
          <p class="text-muted">
          ...
          <h4 class="mb-2 mt-4 text-2xl">Haftung für Inhalte</h5>
          <p class="text-muted">
          ...
          <h4 class="mb-2 mt-4 text-2xl">Haftung für Links</h5>
          <p class="text-muted">
      ...
      >
        ...
        >
          ...
          <p class="text-s text-gray-500 mt-4">
            Unser freundliches Team ist gerne telefonisch für Sie verfügbar.<br />
            <a
              href="tel:021173710707"
        ...
        >
          ...
          <p class="text-s text-gray-500 mt-4">
            ...
            <a href="/cdn-cgi/l/email-protection#11787f777e517c7475786574626523253f727e7c" class="gradient mx-auto inline-flex items-center lg:mx-0 hover:underline text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"><span class="__cf_email__" data-cfemail="b8d1d6ded7f8d5dddcd1ccddcbcc8a8c96dbd7d5">[email&#160;protected]</span></a
            >
          </p>
        </div>
        <!--END SERVICE ITEM-->
      ...
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="/cdn-cgi/l/email-protection#4821262e2708252d2c213c2d3b3c7a7c662b2725" class="no-underline inline-flex hover:underline text-gray-800 hover:text-pink-500">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 mr-2"
                    fill="none"
                  ...
                  >
                    <path
                      ...
                      d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"
                    /></svg
                  ><span class="__cf_email__" data-cfemail="f1989f979eb19c94959885948285c3c5df929e9c">[email&#160;protected]</span></a
                >
              </li>
