...
<head>
    <meta charset="utf-8">
    <title>Politeknik 'Aisyiyah Pontianak | Perpustakaan Politeknik 'Aisyiyah Pontianak</title>
    ...
    <meta name="robots" content="index, follow">        <meta name="description" content="Politeknik 'Aisyiyah Pontianak | Perpustakaan Politeknik 'Aisyiyah Pontianak">
      <meta name="keywords" content="Politeknik 'Aisyiyah Pontianak">
    ...
    <meta property="og:title" content="Politeknik 'Aisyiyah Pontianak | Perpustakaan Politeknik 'Aisyiyah Pontianak"/>
        <meta property="og:description" content="Politeknik 'Aisyiyah Pontianak"/>
      <meta property="og:url" content="//library.polita.ac.id%2Findex.php"/>
    <meta property="og:site_name" content="Perpustakaan Politeknik 'Aisyiyah Pontianak"/>
        <meta property="og:image"
            content="//library.polita.ac.id/template/default/img/logo.png"/>
  
    <meta name="twitter:card" content="summary">
    <meta name="twitter:url" content="//library.polita.ac.id%2Findex.php"/>
    <meta name="twitter:title" content="Politeknik 'Aisyiyah Pontianak | Perpustakaan Politeknik 'Aisyiyah Pontianak"/>
    ...
    <link href="/js/toastr/toastr.min.css?31014238" rel="stylesheet" type="text/css"/>
    <!-- SLiMS CSS -->
    <link rel="stylesheet" href="/js/colorbox/colorbox.css">
    <!-- // Flag css -->
    <link rel="stylesheet" href="template/default/assets/css/flag-icon.min.css">
    <!-- // my custom style -->
    <link rel="stylesheet" href="template/default/assets/css/style.css?v=20220808-014238">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
    <a class="navbar-brand inline-flex items-center" href="index.php">
        <img class="h-10 w-15" src="images/default/logo.png">        <div class="inline-flex flex-col leading-tight ml-2">
            <h1 class="text-lg m-0 p-0">Perpustakaan Politeknik 'Aisyiyah Pontianak</h1>
                    </div>
    </a>
...
<section class="my-5 container">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 pt-8 md:pt-0">
            <h4>Perpustakaan Politeknik 'Aisyiyah Pontianak</h4>
...
<footer class="py-4 bg-grey-darkest text-grey-lighter">
    <div class="container">
        <div class="row py-4">
            <div class="col-md-3">
              <img class="h-16 mb-2" src="images/default/logo.png">                <div class="mb-4">Perpustakaan Politeknik 'Aisyiyah Pontianak</div>
                <ul class="list-reset">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="colltype" class="form-control"
                                    id="adv-coll-type"><option value="0">Semua Koleksi</option><option value="Fiksi">Fiksi</option><option value="Reference">Reference</option><option value="Textbook">Textbook</option></select>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
...
<!-- // load our vue app.js -->
<script src="template/default/assets/js/app.js?v=20220808-014238"></script>
<script src="template/default/assets/js/app_jquery.js?v=20220808-014238"></script>
