...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="viewport" content="width=device-width, maximum-scale=1.0, minimum-scale=1.0, initial-scale=1.0" /><title>
	MensaMax - Login
</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><link rel="shortcut icon" href="favicon.ico" type="image/icon" /><link rel="icon" href="favicon.ico" type="image/icon" />
...
<body class="body">
    <div class="flex items-stretch">
        ...
        <div class="py-6 shadow w-full md:w-1/2 min-h-screen">
            <form name="form1" method="post" action="./login.aspx" id="form1" class="h-full px-6 md:px-12 md:py-6 flex flex-col items-center max-w-2xl mx-auto">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="7O6zk7x5DWARtENEO8GQ3HgAeI6I4aahkwEQEs1UhTCLiahkmT4tL6Pglvp12WjFShC3Ox5k4D/knGFpc6+KfFGq//tAtkkfjwENg+5lU5mnbKYYjT/RjX1uBgdFMqtjYwk/781b3+xMs4tuV1Dz9A==" />


<script src="/ScriptResource.axd?d=QEYGzjfrSIuHG2pwUsHWOfn8Q8-cCx8PUGdNFl9wpH2h6IzSG2jGNupmZhLuJduzg79yZshIZrPh2u2TW3N63NW_UWrrlXyl4yS8R6kHg6TsQElvF3ZClSFqsL3iMJGrepYJAzJPGXXcp7ajCoP3gyftuPL3THBr8PLaKTuSBUI1&amp;t=49337fe8" type="text/javascript"></script>
...
<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
                <div class="flex flex-col items-center space-y-6">

                    <!-- LOGO - mit Versionstext (über ID "divLoginLogo") -->
                    <div id="divLoginLogo" class="relative h-24 w-24 flex-shrink-0" title="MensaMax 3.117.02.07">
                        <svg
		    ...
		    c0.146-0.146,0.226-0.339,0.227-0.545c0-0.118-0.027-0.235-0.079-0.34L12.947,2.091C12.771,1.733,12.399,1.501,11.997,1.501z" />
                        ...
                        <div class="rounded relative w-full">
                            <input name="tbxProjekt" id="tbxProjekt" class="w-full h-9 bg-gray-200 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 transition duration-150 ease-in-out" type="text" name="projekt" value="" style="padding-left: 145px" />
                        ...
                        <span id="lblHinweis" class="block text-center text-red-600"><font color="Red"></font></span>

                        <!-- Submit-Button -->
                        <input type="submit" name="btnLogin" value="Anmelden" onclick="show(&#39;true&#39;);" id="btnLogin" class="appearance-none inline-flex items-center px-12 py-2 border border-transparent text-sm font-semibold rounded-md text-gray-800 bg-yellow-300 hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 transition duration-150 ease-in-out" style="" />
                    </div>
                    <div class="w-full my-6 flex flex-col items-center text-center space-y-4 text-gray-500">
                        ...
                        <div class="flex flex-wrap space-x-2 justify-center">
                            ...
                            <div id="newAccount" class="inline border-b-2 border-yellow-300">
                                <a
                                    href="#"
                                    onclick="createAcc();"
                        ...
                        <div id="forgottenPw" class="block">
                            <div class="inline border-b-2 border-yellow-300">
                                <a href="#"
                                    onclick="doreset();"
                ...
                <div class="prose text-center text-sm text-gray-600">
                    <div>
                        ...
                        <a
                            ...
                            href="https://www.mensamax.de/datenschutz">Datenschutzbestimmungen</a>
