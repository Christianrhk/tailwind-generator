...
-->                                        </ul>
        ...
        <!-- cart start -->
										 <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12" style="padding-top: 40px;padding-bottom: 20px;">
					
						   <div role="alert" class="alert alert-danger"> <strong>Ooops !! You have not added any product to the cart yet.</strong> </div> 	
							</div>	</div>	</div>	
								        <!-- cart end --> 
