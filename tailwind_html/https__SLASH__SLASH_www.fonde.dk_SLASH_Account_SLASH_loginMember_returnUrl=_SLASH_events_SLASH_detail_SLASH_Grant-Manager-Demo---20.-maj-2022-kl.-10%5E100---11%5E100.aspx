...
<ul class="top-nav w-full lg:w-auto toggle-mobile-menu">
    <li class="w-full md:w-auto nav-item relative pointer ">
        ...
        <div id="loginFormNew" class="absolute  header-Login-dropdown">
            <input name="__RequestVerificationToken" type="hidden" value="WynL1-C3X6W_7VgsDqZcwMBFR0FYfvpRW3NGwcMmDWJFjVUtlJVVSkrIdbNo67n9bAKZ003hsQNQEgkDnnYy0_a7Qu8QSrqmCmkMJrWIjQ41" />
            <fieldset>
                        ...
                        <form action="/Account/ForgotPassword" method="post">
                            <div class="ro">
                                ...
                                <div class="form-group pt-5 ForgotPassword-step-1" style="    margin-bottom: 45px;">
                                    <input name="__RequestVerificationToken" type="hidden" value="KgKsR-KdLi70g1BP6NYVKJ8aWsroiICT8xaq9YJBIjVQhgmcbdVVbygbYsEcuq4qQbqVDy6R2NwNhtjW3UpJ_2csPdj2tdq9IRhUJblX1qc1" />
...
<form action="/Account/Login?ReturnUrl=%2Fevents%2Fdetail%2FGrant-Manager-Demo---20.-maj-2022-kl.-10%5E100---11%5E100.aspx" method="post" name="loginpage" onsubmit="return validateForm()" style="width: 100%;"><input name="__RequestVerificationToken" type="hidden" value="TztVd5yUc2rxTk-jRNN9up0opyTpAIHgWz_QcOwzkELNJGYVLkENf_EordFmG1BQ0K-6CSYkGmmtr1mDVIyNaWb0Ko0HYTDxGw6rH73wlIo1" />            <div class="col-xs-12 p-2">
                <h5>
