...
<html lang="de">
  ...
  >
	...
	<div class="w-full flex items-center justify-center px-5">
        <div
          class="flex flex-col md:flex-row animate-in delay-1000 py-5 px-8 mx-3 shadow rounded-2xl bg-white"
          style="max-width: 1250px; border: 2px solid #5fc8cf"
        >
           <div class="mr-3">
            <p class="text-2xl" style="color: #5fc8cf">Wir tragen die Selbstbeteiligung!</p>
            <p class="text-base text-gray-500">
            	Keine Eigenbeteiligung in Höhe von 3€ bei Corona-Schnelltests<br />
            </p>
          </div>
          <div class="flex flex-row">
            <a
              ...
              class="location-scroll animate-in delay-200 mx-auto gradient text-white mt-5 md:mt-0 inline-flex items-center hover:underline bg-white font-bold rounded-full py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 mr-3"
	...
	<div class="w-full flex items-center justify-center px-5">
        ...
        >
          <div class="mr-3">
            <p class="text-2xl" style="color: #5fc8cf">Ab sofort neu!</p>
            <p class="text-base text-gray-500">
              All unsere Testzentren verwenden ausschließlich den Testsieger von Longsee.
              Dieser hat eine 100%tige genauigkeit, auch bei geringer Viruslast.
              (Stand: Paul-Ehrlich-Institut 12.01.22)<br />
            </p>
          </div>
          <div class="flex flex-row">
            <a
              href="https://datawrapper.dwcdn.net/IucVZ/11/"
              target="_blank"
              style="white-space: nowrap"
              class="mx-auto gradient text-white mt-5 md:mt-0 inline-flex items-center hover:underline bg-white font-bold rounded-full py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 mr-3"
              ...
              Welche Schnelltests sind zuverlässig?
            </a>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <h1 class="my-4 text-5xl font-bold leading-tight animate-in">
            MediTest24 Testzentren
          </h1>
          <p class="leading-normal text-2xl mb-8 animate-in delay-100">
            Bürgertests verfügbar.<br>
			Selbstauskunft / Nachweis zur Inanspruchnahme von Testungen nach § 4a TestV <a href="https://www.mags.nrw/sites/default/files/asset/document/selbstauskunft_buergertestung.pdf" target="_blank"> <b>HIER RUNTERLADEN</b> </a>
          </p>
          <button
            class="location-scroll animate-in delay-200 mx-auto inline-flex items-center lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6 mr-3"
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <div class="relative inline-block animate-in delay-300 animate-fade">
            <img
              ...
              src="hero_bg.svg"
            />
            <img style="max-height: 70vh" class="relative" src="hero.svg" />
            <img
              style="max-height: 70vh; left: 0; top: 0; right: 0; bottom: 0"
    ...
    <section class="border-b py-8 bg-white">
      <div class="container mx-auto py-6 mb-12">
        <div
          class="grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 gap-5 mb-10 mx-5 mt--10"
        >
          <!--START FEATURE ITEM-->
          <div class="flex bg-white flex-col p-8 bg-white rounded-2xl">
            <div class="flex items-center justify-between">
              <div class="flex">
                <div style="width: 150px; height: auto" class="mr-5">
                  <img
                    src="./CWA_title.png"
                ...
                <div class="flex flex-col ml-3">
                  <h3 class="text-1xl font-bold text-gray-700">
                    Corona-Warn-App
                  </h3>
                  <p class="text-s text-gray-500 mt-4">
                    Ihr Testergebnis können Sie ganz bequem auf Wunsch in der
                    Corona-Warn-App erhalten.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex">
                ...
                <div class="flex flex-col ml-3">
                  ...
                  <p class="text-s text-gray-500 mt-4">
                    Sie verreisen in der EU? Kein Problem! Wir unterstützen das
                    EU-Zertifikat (DCC).
                  </p>
                </div>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex">
                ...
                <div class="flex flex-col ml-3">
                  ...
                  <p class="text-s text-gray-500 mt-4">
                    All unsere Testergebnisse sind sowohl auf Deutsch als auch
                    auf Englisch.
                  </p>
                </div>
              </div>
        ...
        <!--START PRICE TABLE ITEM-->
        <div
          class="grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-2 gap-5 my-10 mx-5"
        >
          <!--START PRICE ITEM-->
          <div
            class="flex flex-col w-full p-8 space-y-8 text-center bg-white border-2 shadow-md rounded-2xl lg:mx-4"
          >
            <div class="flex-shrink-0">
              <h2
                class="inline-flex items-center justify-center px-3 py-2 tracking-tight rounded-full"
                style="
                  color: #6ac9d1;
                  background-color: rgba(106, 201, 209, 0.2);
                "
              >
            ...
            <ul class="flex flex-col items-center justify-center">
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-700 text-lg ml-3"
                  >Täglich kostenloser Test möglich</span
                >
              </li>
            </ul>
            ...
            <button
              style="white-space: nowrap"
              class="location-scroll mx-auto gradient text-white mt-5 md:mt-0 inline-flex items-center hover:underline bg-white font-bold rounded-full py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 mr-3"
          ...
          >
            ...
            <ul class="flex flex-col items-center justify-center">
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-700 text-lg ml-3"
                  >Ergebnis am selben Tag (optional)</span
                >
              </li>
              ...
              <li class="flex items-center">
                ...
                <span class="text-gray-700 text-lg ml-3"
                  >Nachweis einer akuten Infektion</span
                >
              </li>
            </ul>
...
<!--END PRICE ITEM-->
      ...
      <div
        class="container mx-auto relative z-index:99 px-10"
        style="margin-bottom: -130px; max-width: 600px"
      >
        <div
          class="flex bg-white flex-col p-8 bg-white shadow-md hover:shodow-lg rounded-2xl"
        ...
        >
          <div class="flex items-center justify-between">
            <div class="flex">
              ...
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">Symptome?</h3>
                <p class="text-s text-gray-500 mt-4">
                  Symptome? Bitte kontaktieren Sie direkt Ihren Arzt oder das
                  Gesundheitsamt! Unser Testzentrum kann keine Tests auf das
                  Coronavirus durchführen, wenn Sie Symptome zeigen oder
                  verspüren.
                </p>
              </div>
            </div>
    ...
    <section
      class="locations border-b py-8"
      style="background-color: #f2efe6; padding-top: 150px"
    >
      <div class="container mx-auto text-center py-6 mb-12">
        ...
        <h3
          class="w-full my-2 text-2xl leading-tight text-center inline-block text-gray-800"
        >
          Bitte wählen Sie einen Standort um einen Termin zu vereinbaren
        </h3>
        <div
          class="grid md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-4 gap-5 my-10 mx-5"
        >
			<!--START LOCATION ITEM-->
          <a
            href="https://duesseldorf-tva.meditest24.com/appointments"
            class="flex flex-col p-8 bg-white shadow-lg rounded-2xl"
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">
                  Düsseldorf<br />Angermund
                </h3>
                <p class="text-s text-gray-500 mt-4">
                  TV Angermund<br />Freiheitshagen 33<br />40489 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
                  <b>Öffnungszeiten</b>:<br />Mo. - Fr: 07:00 - 19:00<br />Sa.: 08:30 -
                  19:00<br />So.: 08:30 - 19:00
                </p>
              </div>

              <button
                class="mx-auto inline-flex items-center lg:mx-0 hover:underline gradient font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6 mr-3"
                ...
                <span class="xs:hidden">Termin buchen</span>
              </button>
            </div>
          </a>
          <!--END LOCATION ITEM-->
        ...
        <!--  
		<a
            href="https://duesseldorf-angermund.meditest24.com/appointments"
            class="flex flex-col p-8 bg-white shadow-lg rounded-2xl"
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                ...
                <p class="text-s text-gray-500 mt-4">
                  Hotel Rosenhof<br />Bahnhofstraße 2<br />40489 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
                  <b>Öffnungszeiten</b>:<br />Mo. - Fr: 07:00 - 19:00<br />Sa.: 08:30 -
                  19:00<br />So.: 08:30 - 19:00
...
-->
          ...
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">
                  Düsseldorf<br />Wittlaer
                </h3>
                <p class="text-s text-gray-500 mt-4">
                  TV Kalkum 1911/Wittlaer<br />
                  Grenzweg 15 A<br />40489 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
          ...
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">
                  Düsseldorf<br />Hamm / Bilk
                </h3>
                <p class="text-s text-gray-500 mt-4">
                  DJK Sparta Bilk e.V.<br />
                  Fährstraße 51<br />40221 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
                  <b>Öffnungszeiten</b>:<br />Mo. - Fr: 07:00 - 19:00<br />Sa.: 08:30 -
                  19:00<br />So.: 08:30 - 19:00
          ...
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">
                  Düsseldorf<br />Wersten
                </h3>
                <p class="text-s text-gray-500 mt-4">
                  SV Wersten 04 e. V.<br />
                  Dechenweg 24<br />40591 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
                  <b>Öffnungszeiten</b>:<br />Mo. - Fr: 07:00 - 19:00<br />Sa.: 08:30 -
                  19:00<br />So.: 08:30 - 19:00
          ...
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">
                  Düsseldorf<br />Altstadt
                </h3>
                <p class="text-s text-gray-500 mt-4">
                  (ehemalige Sparkasse)<br />
                  Bolkerstraße 17<br />40213 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
...
-->
          ...
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                ...
                <p class="text-s text-gray-500 mt-4">
                  <br />
                  Bismarckstrasse 93<br />40210 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
                  <b>Öffnungszeiten</b>:<br />Mo. - Fr: 07:00 - 19:00<br />Sa.: 08:30 -
                  19:00<br />So.: 08:30 - 19:00
          ...
          >
            <div class="flex items-center justify-between flex-col">
              <div class="flex flex-col ml-3">
                <h3 class="text-2xl font-bold text-gray-700">
                  Düsseldorf<br />Lohausen / Flughafen
                </h3>
                <p class="text-s text-gray-500 mt-4">
                  Hotel Garni<br />
                  Niederrheinstraße 34<br />40474 Düsseldorf
                </p>
                <p class="text-s text-gray-500 mt-4">
                  <b>Öffnungszeiten</b>:<br />Mo. - Fr: 07:00 - 19:00<br />Sa.: 08:30 -
                  19:00<br />So.: 08:30 - 19:00
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      >
        ...
        >
          ...
          <h3 class="text-lg font-bold text-gray-700">Mit- & ohne Termin</h3>
          <p class="text-s text-gray-500 mt-4">
            Online Terminbuchung wird empfohlen, Sie können aber gerne auch
            spontan vorbei kommen. Sie benötigen nur Ihren Personalausweis oder
            Reisepass.
          </p>
        </div>
        <!--END SERVICE ITEM-->
        ...
        >
          ...
          <p class="text-s text-gray-500 mt-4">
           Die Schnelltests (PoC-Antigen-Schnelltest) sind für alle in Deutschland krankenversicherten Personen kostenlos.
          </p>
        </div>
        <!--END SERVICE ITEM-->
		  <!--START SERVICE ITEM-->
        ...
        >
         <!-- ICON FEHLT -->
          ...
          <p class="text-s text-gray-500 mt-4">
           An allen MediTest24 Standorten werden auch Kinder getestet. Der Abstrich erfolgt aus dem vorderen Nasenbereich (2,5 cm) oder dem Rachen. Teilweise sind auch Lollitests vorhanden.  Eine Einverständniserklärung bzw. bei Kindern unter 14 Jahren eine Anwesenheit eines Erziehungsberechtigten/Sorgeberechtigten erforderlich.
          </p>
        </div>
        <!--END SERVICE ITEM-->
        <!--START SERVICE ITEM-->
        ...
        >
          ...
          <h3 class="text-lg font-bold text-gray-700">Auch in Ihrer Nähe</h3>
          <p class="text-s text-gray-500 mt-4">6 Standorte in Düsseldorf</p>
        </div>
        <!--END SERVICE ITEM-->
        <!--START SERVICE ITEM-->
        <div
        ...
        >
          ...
          <h3 class="text-lg font-bold text-gray-700">Online buchen</h3>
          <p class="text-s text-gray-500 mt-4">
            Einfach und schnell online Termin buchen
          </p>
        </div>
        <!--END SERVICE ITEM-->
        <!--START SERVICE ITEM-->
        ...
        >
          ...
          <h3 class="text-lg font-bold text-gray-700">Kurzfristige Termine</h3>
          <p class="text-s text-gray-500 mt-4">
            Täglich und kurzfristig Termine verfügbar
          </p>
        </div>
        <!--END SERVICE ITEM-->
        <!--START SERVICE ITEM-->
        ...
        >
          ...
          <h3 class="text-lg font-bold text-gray-700">Schnelles Ergebnis</h3>
          <p class="text-s text-gray-500 mt-4">Ergebnis nach 15 Minuten</p>
        </div>
        <!--END SERVICE ITEM-->
        <!--START SERVICE ITEM-->
        <div
        ...
        >
          ...
          <h3 class="text-lg font-bold text-gray-700">Digitale Auswertung</h3>
          <p class="text-s text-gray-500 mt-4">
            PDF als Download und/oder in der Corona-Warn-App.
          </p>
        </div>
        <!--END SERVICE ITEM-->
      </div>
      ...
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          ...
          <div class="flex-1">
            ...
            <ul class="list-reset mb-6">
              <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                <a href="/cdn-cgi/l/email-protection#c1a8afa7ae81aca4a5a8b5a4b2b5f3f5efa2aeac" class="no-underline inline-flex hover:underline text-gray-800 hover:text-pink-500">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 mr-2"
                    fill="none"
                  ...
                  >
                    ...
                    /></svg
                  ><span class="__cf_email__" data-cfemail="751c1b131a351810111c0110060147415b161a18">[email&#160;protected]</span></a
                >
              </li>
