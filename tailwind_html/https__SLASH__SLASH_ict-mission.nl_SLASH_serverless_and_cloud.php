        ...
        <div class="max-w-6xl mx-auto pb-10">
          <div class="lg:flex">
            ...
            <div class="lg:w-3/5 mt-6 lg:mt-0 lg:ml-12">
              <h2 class="font-head font-semibold text-xl lg:text-3xl mb-4">
                Cloud computing <br />
                Revolutionising the way we compute
              </h2>
              <p
                class="font-body text-sm lg:text-base leading-loose font-light"
              >
                The impact serverless (or cloud computing) will have on the 4th digital revolution can not easily be overestimated. Software development, artificial intelligence, automation, storage, data processing all change at the speed of light. This revolution requires a total paradigm shift, and needs new skills and methodological thinking. Chances are you are currently seeking a starting point, expertise, or have already made the switch, and now eagerly seek more capacity. Let us introduce you to how Bangladesh looks at the scale and development of Serverless. 
              </p>
            </div>
          </div>
          ...
          <div class="mt-14 space-y-8">
            <div class="flex items-center">
                <img class="mr-6 w-24 lg:w-52" src="images/brainstation.png" alt="brainstation23" />
              <h3 class="font-head text-base mb-4">
               It was in 2006 Raisul Kabir started <a href="https://brainstation-23.com/"><b>Brain Station 23</b></a>, right after graduating from BUET. The new company initially focused on the international market with the local market added in 2010. Since then the company has shown a continuous growth and currently employs over 400+ software engineers. Brain Station 23 is now not only an established name in Bangladesh but also in countries like the USA, UK, Netherlands, Denmark, Japan, Norway, Sweden, Germany, Canada, Switzerland, Turkey and the Middle East. 
              </h3>
            </div>
            <div class="flex items-center">
                <img class="mr-6 w-24 lg:w-52" src="images/shadhin-labs.png" alt="shadhin-labs" />
              <h3 class="font-head text-base mb-4">
                As an official AWS solutions partner, <A href="http://shadhinlab.com/" target="_blank"><b>Shadhin Lab</b></A> caught our eye for working on Covid response programs in the USA. Current customers are from North America (US Local Government, Enterprise), Europe (Manufacturing), Japan (IoT/AR/VR) and local Bangladeshi government and enterprises. Shadhin Labs now specializes in Cloud Migrations and Cloud management. With learnings taken from the massive Cloudcamp courses, they operate in machine learning, along with AI/ML, IoT, Robotics, AR/VR and DevOps. 
              </h3>
            </div>
       <!--      <div class="flex items-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-6 lg:gap-52 mt-10">
          <div>
            <h2 class="font-head text-base lg:text-3xl font-medium mb-4">
              Serverless education. At Scale
            </h2>
            <p class="text-sm font-light font-body leading-loose">
              If you are familiar with Serverless, you know its in high demand worldwide. Through free programs given by senior executives of Amazon, post graduate students follow weekly classes on Zoom and Slack. Massive classes where the number of participants runs in the thousands. All eagerly to become certified in Amazon Serverless, Storage, and Security through Cloudcamp Bangladesh. The amazing thing about CloudCamp Bangladesh, is its free, run by volunteers, and focusses strongly on women to participate in this journey. 
            </p>
          </div>
          <div>
            <div class="max-w-sm ml-auto mt-6 lg:mt-0">
              <img class="w-full" src="images/mahdee.png" alt="" />
              <p class="text-sm font-light font-body leading-loose ">
                <a href="https://www.linkedin.com/in/mohammadzaman" target="_blank"><b>Mohammad Zaman</b></a>, or "Mahdee", is the Leader of Solutions Architecture at Amazon US-NE, and has been living in the United States for a long time. Through his programs he aspires to bring knowledge about cloud computing to the nation where his roots lie. It's not uncommon for his sessions to be joined by over 5.000 participants! 
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-3 md:grid-cols-5 gap-4 lg:gap-10">
          ...
          <div class="relative"><a href="workspace_services.php">
            <img class="w-full" src="images/workspace.png" alt="Workspace services and remote management" />
            <div>
              <h3 class="font-head text-base font-medium">
          ...
          <div class="relative"><a href="content_graphics_3d_cgi.php">
            <img class="w-full" src="images/postproduction.png" alt="Post production and creative services" />
            <div>
              <h3 class="font-head text-base font-medium">
          ...
          <div class="relative"><a href="mobile_app_game.php">
            <img class="w-full" src="images/campus_chittagong.jpeg" alt="Mobile and App development" />
            <div>
              <h3 class="font-head text-base font-medium">
          ...
          <div class="relative"><a href="startup_investment.php ">
            <img class="w-full" src="images/image_6.jpg" alt="A thriving startup scene" />
            <div>
              <h3 class="font-head text-base font-medium">
