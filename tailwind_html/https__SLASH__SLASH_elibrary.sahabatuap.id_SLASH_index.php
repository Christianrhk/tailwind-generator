...
<head>
    <meta charset="utf-8">
    <title>Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu | PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU</title>
    ...
    <meta name="robots" content="index, follow">        <meta name="description" content="Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu | PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU">
      <meta name="keywords" content="Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu">
    ...
    <meta property="og:title" content="Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu | PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU"/>
        <meta property="og:description" content="Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu"/>
      <meta property="og:url" content="//elibrary.sahabatuap.id%2Findex.php"/>
    <meta property="og:site_name" content="PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU"/>
        <meta property="og:image"
            content="//elibrary.sahabatuap.id/template/default/img/logo.png"/>
  
    <meta name="twitter:card" content="summary">
    <meta name="twitter:url" content="//elibrary.sahabatuap.id%2Findex.php"/>
    <meta name="twitter:title" content="Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu | PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU"/>
    ...
    <link href="/js/toastr/toastr.min.css?31061218" rel="stylesheet" type="text/css"/>
    <!-- SLiMS CSS -->
    <link rel="stylesheet" href="/js/colorbox/colorbox.css">
    <!-- // Flag css -->
    <link rel="stylesheet" href="template/default/assets/css/flag-icon.min.css">
    <!-- // my custom style -->
    <link rel="stylesheet" href="template/default/assets/css/style.css?v=20220808-061218">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
    <a class="navbar-brand inline-flex items-center" href="index.php">
            ...
            <h1 class="text-lg m-0 p-0">PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU</h1>
                        <h2 class="text-sm lead m-0 p-0">Jl. A. Yani No. 1A Tambahrejo Gadingrejo, Pringsewu</h2>
                    </div>
    </a>
...
<section class="my-5 container">
    <div class="row align-items-center">
        ...
        <div class="col-md-6 pt-8 md:pt-0">
            <h4>PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU</h4>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque et nunc mi. Donec vehicula turpis a quam venenatis posuere. Aliquam nibh lectus, gravida et leo sit amet, dignissim dapibus mauris.<br />Telp. (021) 9172638<br />Fax. (021) 9172638</p>
        ...
        <div class="row py-4">
            <div class="col-md-3">
                    ...
                    c0.3,0.2,0.5,0.5,0.6,0.9l0,62.3L114.4,98.8L114.4,98.8z M95.3,68.6v39.4L23.1,66.4V26.9L95.3,68.6z"/>
                              ...
                              <div class="mb-4">PERPUSTAKAAN UNIVERSITAS AISYAH PRINGSEWU</div>
                <ul class="list-reset">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="colltype" class="form-control"
                                    id="adv-coll-type"><option value="0">Semua Koleksi</option><option value="Fiction">Fiction</option><option value="Textbook">Textbook</option></select>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
...
<!-- // load our vue app.js -->
<script src="template/default/assets/js/app.js?v=20220808-061218"></script>
<script src="template/default/assets/js/app_jquery.js?v=20220808-061218"></script>
